...
class ParallelCountChangeSuite extends FunSuite {
  ...
  test("mythreshold money should be false if input value higher than 2/3") {
    assert(moneyThreshold(30)(50, List())==false)
  }

  test("mythreshold money should be true if input value equal to 2/3") {
    assert(moneyThreshold(3)(2, List())==true)
  }


  test("totalCoinsThreshold coins should be false if input value higher than 2/3") {
    assert(totalCoinsThreshold(20)(10, List())==true)
  }
